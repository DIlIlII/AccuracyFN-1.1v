...
namespace addresses
{
	...
	extern PVOID ClientSetCameraMode;
...
namespace offsets
{
	...
	{
		CachedWorldSpaceBounds = 0x5F8, // dead offset
	};
	...
	enum FortPawn : uint64_t
	{
		...
		LastFireTime = 0x8EC, // nicely done
	};
	...
	{
		ReloadTime = 0xFC, // Relead That Hoe
	};
